...
pred[1:5]
pred14 = ifelse(pred>0.017,1,0)
sub14 = data.frame(ID = Ids)
sub14$Approved = pred14
length(sub14$Approved[sub14$Approved==0])
write.csv(sub14,'MckinseyHack14.csv',row.names = F)
