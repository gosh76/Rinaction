...
pred[1:5]
pred15 = ifelse(pred>0.0155,1,0)
sub15 = data.frame(ID = Ids)
sub15$Approved = pred15
length(sub15$Approved[sub15$Approved==0])
write.csv(sub15,'MckinseyHack15.csv',row.names = F)
