...
pred[1:5]
pred11 = ifelse(pred>0.01,1,0)
sub11 = data.frame(ID = Ids)
sub11$Approved = pred11
length(sub11$Approved[sub11$Approved==0])
write.csv(sub11,'MckinseyHack11.csv',row.names = F)
