...
pred[1:5]
pred12 = ifelse(pred>0.015,1,0)
sub12 = data.frame(ID = Ids)
sub12$Approved = pred12
length(sub12$Approved[sub12$Approved==0])
write.csv(sub12,'MckinseyHack12.csv',row.names = F)
